...
Form_Dialog_finish, QDialogClass = uic.loadUiType(resource_path("Dialog_finish.ui"))
...
class ui(QtBaseClass, QDialogClass, Form_Home, Form_Main, Form_Dialog_start, Form_Dialog_after_start):
	...
	def Dia_Finish(self):
		self.dialog6 = QDialogClass()
		self.form_d6 = Form_Dialog_finish()
		self.form_d6.setupUi(self.dialog6)
